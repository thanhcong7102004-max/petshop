                    ...
                    <?php foreach ($products as $product): ?>
                        <div class="product-card">
                            ...
                            <?php elseif ($product['stock'] == 0): ?>
                                <div class="product-badge out-stock">Hết hàng</div>
                            <?php elseif ($product['stock'] > 0 && $product['stock'] <= 10): ?>
                                <div class="product-badge low-stock">Sắp hết (<?= $product['stock'] ?>)</div>
                            <?php else: ?>
                                <div class="product-badge in-stock">Còn hàng</div>
                            <?php endif; ?>
